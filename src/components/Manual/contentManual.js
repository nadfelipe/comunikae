exports.contentManual = [
    ...
    {
        id: 4,
        titulo: 'Caraca, olha esse post!',
        texto: 'No mural você vai encontrar todas as postagens das outras equipes, como: vídeos cumprindo os desafios, projetos realizados e etc. Ele funciona como um feed e olha que fantástico! Nele você pode aplicar filtros para visualizar o que mais te interessa, como as postagens mais criativas, ou mais visualizadas.',
        texto2: ' E quando seu foco for outro é só editá-los ou excluir os filtros que não quer mais, melhorando a sua experiência.',
        urlImg: '',
        nomeContent: 'Mural'
    },
    {
